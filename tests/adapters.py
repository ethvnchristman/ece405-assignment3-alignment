...
from cs336_alignment.baseline import parse_mmlu_response, parse_gsm8k_response
from cs336_alignment.dataset import PackedSFTDataset, batch_iter
...
def run_iterate_batches(
    ...
    """
    return batch_iter(dataset, batch_size=batch_size, shuffle=shuffle)
